  ...
  <div class="row pt-4 p-0">
    <div class="col-xl-12">
      <div class="panel panel-flat dashboard-main-col mt-4">
        <button class="btn btn-default btn-labeled btn-lg mr-2 mt-2 stopSound float-right" data-popup="tooltip" data-placement="top" title="{{ __('storeDashboard.dashboardStopSound') }}" style="background-color: #F5F5F5;"><i class="icon-volume-mute5"></i></button>
              ...
              <tr>
                ...
                <td class="text-center new-order-actions">
                  ...
                  <a href="{{ route('restaurant.cancelOrder', $nO->id) }}"
                    ...
                    data-placement="top" title="{{ __('storeDashboard.dashboardDoubleClickMsg') }}"> <b><i
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-default btn-labeled btn-lg mr-2 stopSound" data-popup="tooltip" data-placement="top" title="{{ __('storeDashboard.dashboardStopSound') }}" style="background-color: #F5F5F5;">
