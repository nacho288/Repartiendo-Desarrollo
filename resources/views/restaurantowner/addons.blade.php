                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    @if($addon->is_active)
                                        <a href="{{ route('restaurant.disableAddon', $addon->id) }}" class="badge badge-primary badge-icon mr-1" data-popup="tooltip" title="{{ __('storeDashboard.apeEnableAddon') }}" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @else
                                        <a href="{{ route('restaurant.disableAddon', $addon->id) }}" class="badge badge-danger badge-icon mr-1" data-popup="tooltip" title="{{ __('storeDashboard.apeDisableAddon') }}" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @endif
