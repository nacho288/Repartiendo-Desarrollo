                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <a href="{{ route('restaurant.disableItem', $item->id) }}"
                                        ...
                                        title="{{__('storeDashboard.ipToolTipDisable')}}" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @else
                                    <a href="{{ route('restaurant.disableItem', $item->id) }}"
                                        class="badge badge-primary badge-icon ml-1" data-popup="tooltip"
                                        title="{{__('storeDashboard.ipToolTipEnable')}}" data-placement="bottom" style="background-color: #FF5722">
