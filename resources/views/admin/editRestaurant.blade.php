        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.updateRestaurant') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Deeplink Alias:</label>
                        <div class="col-lg-9">
                            <input value="{{ $restaurant->deeplink_alias }}" type="text" class="form-control form-control-lg" name="deeplink_alias"
                                placeholder="Store deeplink alias">
                        </div>
                    </div>
                    <div class="form-group row">
