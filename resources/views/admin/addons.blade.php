                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    @if($addon->is_active)
                                        <a href="{{ route('admin.disableAddon', $addon->id) }}" class="badge badge-primary badge-icon mr-1" data-popup="tooltip" title="Disable Addon" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @else
                                        <a href="{{ route('admin.disableAddon', $addon->id) }}" class="badge badge-danger badge-icon mr-1" data-popup="tooltip" title="Enable Addon" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @endif
