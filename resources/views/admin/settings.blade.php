                ...
                <form action="{{ route('admin.saveSettings') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                            ...
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg min-payout" name="minPayout"
                                            ...
                                            placeholder="Minimum Payout for Store in {{ config('settings.currencyFormat') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <option value="25" @if(config('settings.uploadImageQuality')=="25" )
                                        selected @endif>Low</option>
                                        <option value="50" @if(config('settings.uploadImageQuality')=="50" )
                                        selected @endif>Medium</option>
                                        <option value="75" @if(config('settings.uploadImageQuality')=="75" )
                                        selected @endif>Standard</option>
                                        <option value="100" @if(config('settings.uploadImageQuality')=="100" )
                            ...
                            <div class="tab-pane fade" id="smsGatewaySettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <option @if(config('settings.defaultSmsGateway') == $sms_gateway->id ) selected @endif value="{{$sms_gateway->id}}">{{$sms_gateway->gateway_name}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                                <hr>
                                <div id="msg91Settings" class="@if (config('settings.defaultSmsGateway') != "1") hidden @endif">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="msg91AuthKey"
                                            value="{{ config('settings.msg91AuthKey') }}" placeholder="MSG91 Auth Key">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="msg91SenderId"
                                            value="{{ config('settings.msg91SenderId') }}"
                                            placeholder="MSG91 Sender ID">
                                    </div>
                                </div>
                                <hr>
                            </div>
                            <div id="twilioSettings" class="@if (config('settings.defaultSmsGateway') != "2") hidden @endif">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="twilioFromPhone"
                                        value="{{ config('settings.twilioFromPhone') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="otp_message"
                                    value="{{ config('settings.otpMessage') }}" placeholder="OTP Message: ">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                            ...
                            <div class="checkbox checkbox-switchery mt-2">
                                <div class="col-lg-9">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                                    @if(config('settings.smsRestaurantNotify') == "true" ) checked="checked" @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="defaultSmsRestaurantMsg"
                                    value="{{ config('settings.defaultSmsRestaurantMsg') }}" placeholder="Store Owners new order message">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="checkbox checkbox-switchery mt-2 ">
                                <div class="col-lg-9">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                                    @if(config('settings.smsRestOrderValue') == "true" ) checked="checked" @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                                    @if(config('settings.smsDeliveryNotify') == "true" ) checked="checked" @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="defaultSmsDeliveryMsg"
                                    value="{{ config('settings.defaultSmsDeliveryMsg') }}" placeholder="Delivery Guys new order message">
                            </div>
                        </div>
                        <hr>
                        {{-- 
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                                    @if(config('settings.smsOrderNotify') == "true" ) checked="checked" @endif
                                    name="smsOrderNotify">
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="emailSettings">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Api Key</strong></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="sendgrid_api_key"
                                    value="{{ config('settings.sendgrid_api_key') }}" placeholder="SendGrid API Key">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"><span class="font-weight-bold text-danger"> <i class="icon-exclamation"></i> This is an irreversible action.</span></h5>
